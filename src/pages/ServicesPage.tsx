...
export default function ServicesPage() {
  const services = [
    {
      ...
      description: "Complete battery diagnostics and optimization services for all EV models",
      features: ["Health check", "Performance optimization", "Replacement service"]
    },
    {
      icon: <Wrench className="w-12 h-12 text-emerald-600" />,
      title: "Maintenance",
      description: "Regular maintenance and check-ups to keep your EV in perfect condition",
      features: ["System diagnostics", "Software updates", "Component checks"]
    },
    {
      icon: <Sparkles className="w-12 h-12 text-emerald-600" />,
      title: "Cleaning Services",
      description: "Professional cleaning and detailing services for your vehicle",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-emerald-50">
      ...
      <div className="relative h-64 bg-emerald-700 overflow-hidden">
        <img
